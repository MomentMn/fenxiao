 ...
 *    个人体现工具类
 *    商户平台->个人
 * @projectName: com.hansan.fenxiao.pay.wxpay
 * @className: fenxiao
 * @author:谭农春
 * @createTime:2018/6/5 16:02
 */
@Service
public class  WxPayforPersonUtils{
...
//  }
   ...
   */
  public static Map<String, String> transfer(String path ,String openid, int amount, String desc, String partner_trade_no) {
    ...
    try {
      ...
      String appid = WechatConstant.APPID;// 微信分配的公众账号ID（企业号corpid即为此appId）
      String mchid = WechatConstant.MCH_ID;// 微信支付分配的商户号
      // 设置支付参数
      ...
      // 从配置文件里读取证书的路径信息
      FileInputStream instream = new FileInputStream(new File(path.concat("/apiclient_cert.p12")));
      ...
      //
      HttpPost httpost = new HttpPost(WechatConstant.PAY_FOR_URL);
