...
<body>
	...
	<section class="sn-main pr">
		<div class="sn-block">
			<a href="levelList?type=0" class="input-a  wbox mt30 pr" >
				<span>总共下级人数:</span>
		...
		<div class="sn-block">
			<a href="levelList?type=1" class="input-a  wbox mt30 pr">
				<span>第一级人数:</span>
		...
		<div class="sn-block">
			<a href="levelList?type=2" class="input-a  wbox mt30 pr">
				<span>第二级人数:</span>
		...
		<div class="sn-block">
			<a href="levelList?type=3" class="input-a  wbox mt30 pr">
				<span>第三级人数:</span>
