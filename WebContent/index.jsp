...
<div class="index-wrap lazyimg" id="indexWrap">
	<div class="floor w lazyimg" id="floor">
		...
		<div class="app06 floor-area" id="navCarousel_box">
				<ul class="fix">
					<li style="width: 25%" ><a name="index_none_floor3_330052" href="user/index.jsp">
					<img alt="" data-src="done" src="images/143262193526726791.jpg"><div class="title">个人中心</div></a></li>
					<li style="width: 25%"><a name="index_none_floor3_330051" href="user/promote.jsp">
					<img alt="" data-src="done" src="images/143262190460206422.jpg"><div class="title">我的二维码</div>
					</a></li>
					<li style="width: 25%"><a name="index_none_floor3_330053" href="user/ordersList.jsp"><img alt="" data-src="done" src="images/143262692801385199.jpg"><div class="title">我的订单</div></a></li>
					<li style="width: 25%"><a name="index_none_floor3_330054" href="user/commissionList.jsp">
					<img alt="" data-src="done" src="images/143385213411317884.jpg">
					<div class="title">佣金明细</div></a></li>
				</ul>
		</div>
		<div class="app01"></div>
	...
	<script>
$(function(){
	<%--var isVisited="${sessionScope.loginUser.wxName }"--%>
	<%--if(!isVisited){--%>
		<%--location="http://fenxiao.ceshi.xingaokaowang.cn/code"--%>
	<%--}--%>
	list();
});
function list(){
